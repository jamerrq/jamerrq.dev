...
Decidí usar <a href="https://astro.build" target="_blank" rel="noopener noreferrer" title="Astro">Astro</a>. Astro es un framework que te permite
...
<a href="https://pnpm.io" rel="noopener noreferrer" target="_blank" title="Pnpm.io">pnpm</a> y
...
<a href="https://bun.sh" rel="noopener noreferrer" target="_blank" title="Bun.sh">Bun</a>. Bun
...
target="_blank" title="Eslint">ESLint</a> es una herramienta para identificar y reportar
...
<div align="center" class="m-4">
<a href="https://eslint.org/" rel="noopener noreferrer" target="_blank" title="Eslint" title="Prettier">
...
noreferrer" title="Prettier.io">Prettier</a> es un formateador de código con opiniones. Aplica un
...
noreferrer" title="Tailwind CSS">Tailwind CSS</a> es un framework CSS que te permite crear estilos
...
noreferrer" title="Husky">Husky</a> es una herramienta que te permite ejecutar scripts cuando
...
rel="noopener noreferrer" title="Husky docs">documentación de Husky</a> para más
información.
...
noreferrer" title="Preactjs">Preact</a> es una alternativa rápida de 3kB a React con la misma API
...
noreferrer" title="Deno Deploy">Deno Deploy</a> es una plataforma distribuida globalmente para
