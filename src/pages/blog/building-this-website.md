...
noreferrer" title="Astro">Astro</a>. Astro is a framework that allows
...
<a href="https://astro.build" target="_blank" rel="noopener noreferrer" title="Astro">
...
target="_blank" rel="noopener noreferrer" title="Web design trend: bento box">Web design trend: bento box</a>
...
<a href="https://pnpm.io" rel="noopener noreferrer" target="_blank" title="Pnpm.io">pnpm</a> and I really like it. It's very fast and efficient, it
...
runtime tool <a href="https://bun.sh" rel="noopener noreferrer" target="_blank" title="Bun.sh">Bun</a>. Bun is a new package manager that is still in
...
> <a href="https://bun.sh" rel="noopener noreferrer"
> target="_blank" title="Bun.sh">Bun</a> is an all-in-one JavaScript runtime & toolkit designed for speed,
...
<a href="https://eslint.org/" rel="noopener noreferrer" target="_blank" title="Eslint">ESLint</a> is a tool for identifying and reporting on patterns found in
...
<a href="https://prettier.io" target="_blank" rel="noopener noreferrer" title="Prettier.io">Prettier</a> is an opinionated code formatter. It enforces a consistent style by
...
title="Tailwind CSS">Tailwind CSS</a> is a CSS framework that allows you to create
styles quickly and
...
target="_blank" rel="noopener noreferrer" title="Embracing the Utility-First Paradigm:
Benefits of Tailwind CSS">Embracing the Utility-First Paradigm:
...
noreferrer" title="Husky">Husky</a> is a tool that allows you to run scripts when you commit or push code to
...
noreferrer" title="Husky docs">Husky documentation</a> for more information.

### Fonts: Fontsource

<a href="https://fontsource.org/" target="_blank" rel="noopener
noreferrer" title="Fontsource">Fontsource</a> is a collection of open-source fonts that are
packaged into
...
target="_blank" rel="noopener noreferrer" title="Fontsource docs">Fontsource documentation</a> for
...
<a href="https://preactjs.com/" target="_blank" rel="noopener noreferrer" title="Preactjs">Preact</a> also comes with an implementation of the modern signals that allow you
...
<a href="https://preactjs.com/" target="_blank" rel="noopener noreferrer" title="Preactjs">Preact</a> is a fast 3kB alternative to React with the same modern API. It provides
...
<a href="https://preactjs.com/" target="_blank" rel="noopener noreferrer" title="Preactjs">
<div align="center" class="m-4">
...
<a href="https://deno.com/deploy" target="_blank" rel="noopener noreferrer" title="Deno Deploy">
